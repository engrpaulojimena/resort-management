...
import {
  Users, BedDouble, Wifi, Wind, Tv, Droplets,
  Waves, Star, ChevronLeft, ChevronRight, X, Check
} from 'lucide-react'

const room = {
  id: 'aframe-villa',
  images: ['/images/19291.jpg', '/images/19292.jpg', '/images/19293.jpg', '/images/19294.jpg', '/images/19295.jpg'],
  name: 'A-Frame Villa',
  tag: 'Most Popular',
  tagColor: 'bg-ocean-500',
  capacity: 'Up to 7 Guests',
  beds: 'Upper & Lower Floor',
  units: 10,
  price: 7500,
  description:
    'Experience our signature two-floor A-frame villa featuring both a ground floor and upper loft — perfect for families and groups of up to 7. Wake up to the sound of the waves, take a dip in our infinity pool, and relax in the comfort of your private villa tucked within the lush grounds of Kekamiya Resort.',
  amenities: [
    ...
    { icon: Users, label: 'Up to 7 Guests' },
  ],
  highlights: [
    'Ground floor & upper loft',
...
const policies = [
  ...
  { label: 'Security Deposit', value: '₱2,000 per villa' },
  { label: 'Cancellation', value: 'Free 48 hrs before check-in' },
...
function LightboxModal({ onClose }: { onClose: () => void }) {
      ...
      >
        ...
        <div className="p-8">
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
            <div>
              ...
              <div className="flex items-center gap-4 text-gray-500 text-sm mt-2">
                ...
                <span className="text-gray-400">{room.units} units available</span>
              </div>
            </div>
            <div className="text-right shrink-0">
              <span className="text-xs text-gray-400 block">Rate per night</span>
          ...
          <div className="bg-gray-50 rounded-2xl p-5 mb-6">
            <h3 className="font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wider">Villa Highlights</h3>
...
export default function AccommodationsClient() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-4 max-w-xl mx-auto">
              Each villa spans two floors with the signature A-frame architecture, combining rustic charm with modern comfort — perfect for up to 7 guests.
            </p>
          </div>

          {/* Single villa card — centered, max width */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { icon: Droplets, title: 'Hot Shower', desc: 'Enjoy a refreshing hot shower in your en-suite bathroom anytime.' },
      ...
      {/* Lightbox */}
      {showModal && (
        <LightboxModal onClose={() => setShowModal(false)} />
      )}
    </>
  )
}